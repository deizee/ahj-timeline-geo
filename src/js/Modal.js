export default class Modal {
        ...
        <div class='modal__content'>
          ...
          <div class='modal__body'>
            <div class='modal__text'>
              Unfortunately, we were unable to determine your location, please give permission 
              to use geolocation, or enter the coordinates manually.
            </div>
            <form class='modal__form' name='modal-form'>
              <div class='form__group'>
                <label class='form__label' for='username-field'>
                  Latitude and longitude separated by commas
                </label>
                <input class='form__input' name='coordinates' placeholder='Please enter your coordinates...'>
  ...
  subscribeOnEvents() {
    ...
    this.modalOkElement.addEventListener('click', (event) => this.submit(event));
